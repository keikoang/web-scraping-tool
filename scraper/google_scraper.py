        ...
        with open(self.log_path, "r") as file:
            for line in file:
                ...
                try:
                    ...
                    sys.stdout.write("\rDownloaded images: {}".format(image_counter))
                    sys.stdout.flush()
                    time.sleep(0.2)
                except:
                ...
                image_counter += 1
        sys.stdout.write("\rDownloaded images: {}/{}".format(image_counter, self.image_number))
        sys.stdout.flush()
        print("\n")

        # if user downloaded all available images related to the keyword
        if image_counter < self.image_number:
            print("You have downloaded all {} images.".format(self.keyword))
            print("No more {} images are available to be downloaded.".format(self.keyword))
